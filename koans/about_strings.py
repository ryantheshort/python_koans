...
class AboutStrings(Koan):
    ...
    def test_single_quoted_strings_are_also_strings(self):
        ...
        # single or double quotes are strings
        # self.assertEqual(__, isinstance(string, str))
        self.assertEqual(True, isinstance(string, str))

    def test_triple_quote_strings_are_also_strings(self):
        string = """Howdy, world!"""
        # triple quotes are also strings and can span multiple lines.
        # self.assertEqual(__, isinstance(string, str))
        self.assertEqual(True, isinstance(string, str))
    ...
    def test_raw_strings_are_also_strings(self):
        ...
        # raw strings treat backslashes as actual characters
        # used to handle file paths, for example
        # self.assertEqual(__, isinstance(string, str))
        self.assertEqual(True, isinstance(string, str))
    ...
    def test_use_backslash_at_the_end_of_a_line_to_continue_onto_the_next_line(self):
        # displays on seperate lines when print() is used.
